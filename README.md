...
**2. Notarization** — pick one trio; Tauri accepts both:

| Secrets | What they are |
|---|---|
| `APPLE_ID`, `APPLE_PASSWORD`, `APPLE_TEAM_ID` | your Apple ID, an *app-specific password* created at appleid.apple.com, and the team ID |
